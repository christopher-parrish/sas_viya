...
#####################################################
###     Train & Register XGBoost SciKit Model     ###
#####################################################
...
port = 443
os.environ['CAS_CLIENT_SSL_CA_LIST']=str(wd)+str('/ca.pem')
conn =  swat.CAS(hostname, port, username=username, password=password, protocol='https')
print(conn)
...
model_name = 'xgboost_scikit_python'
