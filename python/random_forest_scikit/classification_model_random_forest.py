...
model_name = 'random_forest_python'
project_name = 'Risk Score'
description = 'Random Forest Python'
...
### estimate & fit model
dm_model = ensemble.RandomForestClassifier(**rf_params)
...
dm_scoreddf_class[dm_classtarget_intovar] = dm_scoreddf_prob.apply (lambda row: binary_col(row), axis=1)
